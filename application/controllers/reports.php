...
class Reports extends CI_Controller
{
	...
	function manage_attendance($date='',$month='',$year='',$class_id='')
	{
		...
		if($_POST)
		{
			...
			redirect(base_url() . 'index.php?reports/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id , 'refresh');
		}
		$page_data['date']			=	$date;
	...
	{
		redirect(base_url() . 'index.php?reports/manage_attendance/'.$this->input->post('date').'/'.
