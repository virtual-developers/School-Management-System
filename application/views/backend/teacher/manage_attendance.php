...
<!------CONTROL TABS START------->
        ...
        <a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
                                <?php echo get_phrase('all_student_attendence');?>
                </a></li>
                <li>
        <a href="#add" data-toggle="tab"><i class="entypo-menu"></i>
                                <?php echo get_phrase('student_daily_attendence');?>
                </a></li>
        </ul>
...
<!------CONTROL TABS END------->
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <tbody>
                    <form method="post" action="<?php echo base_url();?>index.php?reports/attendance_selector" class="form">
                    <tr class="gradeA">
                        <td>
