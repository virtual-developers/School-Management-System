        ...
        <div class="col-sm-offset-4 col-sm-4">
         ...
         <div class="pull-right col-sm-4">
            ...
            <div class="tile-stats tile-white-gray">
                ...
                <h3>Mark All as :</h3>
                <p>Present <input type="radio" name="mark_attendance" onclick="mark_attendance(1)" />
                Absent <input type="radio" name="mark_attendance" onclick="mark_attendance(2)" /></p>
            </div>
        </div>
...
<div class="col-sm-offset-3 col-md-6">
    ...
    <table  class="table table-bordered">
        ...
        <tbody>
			...
			?>
                                <tr><td colspan="3"> <p class="pull-right"><input type="submit" class="btn btn-default" 	value="save" style="float:left; margin:0px 10px;"></p></td></tr>
    </table>
                            </form>
</div>
</div>
...
<script>
    function mark_attendance(status)
    {
        
$( ".att_status" ).each(function() {
    $(this).val(status);
