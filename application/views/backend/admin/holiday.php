            ...
            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_holiday_add/');" 
            	class="btn btn-primary pull-right">
                <i class="entypo-plus-circled"></i>
            	<?php echo get_phrase('Add Holiday');?>
                </a> 
                <br><br>
               ...
               <th><div><?php echo get_phrase('Action');?></div></th>
                    ...
                    <tbody>
                        <?php 
                                $teachers	=	$this->db->get('holidays' )->result_array();
