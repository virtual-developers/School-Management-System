...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Virtual-Developers School Management System PRO | web installer</title>
    ...
    <body>
    	<center><br>
        	<h1>
            	Virtual-Developers School Management System PRO
            </h1>
                ...
                <div id="steps">
                    <?php echo form_open('install/do_install' , array('id' => 'formElem' , 'name' => 'formElem'));?>
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                <label for="name" style="width:156px !important;">Virtual-Developers username</label>
                                <input id="codecanyon_username" name="buyer" type="text"  value="test" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
                                <label for="phone" style="width:156px !important;">Item Purchase Code</label>
                                <input id="purchase_code" type="text" value="test" AUTOCOMPLETE=OFF></textarea>
                            </p>
                        </fieldset>
                        <fieldset class="step">
